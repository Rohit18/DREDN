...
learn = unet_learner(data, arch, wd=wd, loss_func=F.l1_loss, blur=True, norm_type=NormType.Weight, self_attention=True, metrics=[root_mean_squared_error], pretrained=False)
...
path_gen = '/users/PAS1437/osu10674/MM/Datasets/M31_UT_Valid/'
